...
class BotConfig:
    ...
    def __init__(self):
        ...
        # Single source of truth for Stripe credentials. Env name is
        # STRIPE_SECRET_KEY (matches Stripe's own dashboard wording); the Python
        # attribute keeps the legacy name `stripe_api_key` for downstream callers.
        self.stripe_api_key: str = self._get_optional_env("STRIPE_SECRET_KEY", "")
